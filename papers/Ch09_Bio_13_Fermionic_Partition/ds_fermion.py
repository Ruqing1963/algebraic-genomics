...
def load_phix():
    for nm in ("phix174_NC_001422.1.txt", os.path.join("..", "Ch08_Bio_12_Frontier_Elimination", "phix174_NC_001422.1.txt"),
               os.path.join("..", "Ch07_Bio_08_DS_Lattice_Sum", "phix174_NC_001422.1.txt")):
