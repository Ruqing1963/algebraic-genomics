...
chapters were written as papers; we have removed repetitions, unified the notation and merged the
bibliographies, but each chapter still opens with a summary that can be read alone.
