...
script: \texttt{-{}-quick} in about half an hour, \texttt{-{}-full}, including the long computations, in about three hours.
The last column gives the checks of the reference transcript.

\medskip
{\small
\renewcommand{\arraystretch}{1.15}
\begin{longtable}{>{\raggedright\arraybackslash}p{0.30\textwidth}l>{\raggedright\arraybackslash}p{0.39\textwidth}r}
\toprule
